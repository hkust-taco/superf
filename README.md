...
You need [JDK supported by Scala][supported-jdk-versions], [sbt][sbt], and [Node.js][node.js] to compile the project and run the tests.
...
- `Lexer.scala` contains the lexer class.
...
- `Parser.scala` contains the parser class.
